    ...
    <>
      ...
      <StyledFarm>
        ...
        <StyledInfo style={{color: '#ff9800'}}>
          ...
          automagically harvest your rewards for you!
        </StyledInfo>
        <Spacer size="lg" />
        <StyledCardsWrapper>
          <div>
            ...
            <StyledInfoLP>
              ...
              <div style={{width: 'calc(100% - 70px', color: '#ffffff', fontSize: 16, marginLeft: 20, marginRight: 20}}>
                <div>Add liquidity to <a style={{color: '#f6b944', textDecoration: 'none'}} href={pairLink} target="__blank"><b>{symbolShort} pair</b></a> on {protocal} to get <span style={{color: '#f6b944'}}>{lpToken}</span> tokens. Then deposit those LP tokens here to receive multiplier</div>
                <Spacer size="sm" />
