    ...
    <StyledWrapper>
      ...
      <Card>
        <CardContent>
          <StyledBalance>
            {/* <SushiIcon /> */}
            <img src={Luas} alt="Total CMT Supply"/>
            <Spacer />
            <div style={{ flex: 1 }}>
              <Label text="CMT Supply" />
              <Value
                value={circulatingSupply ? getBalanceNumber(totalSupply) : '~'}
              />
            </div>
          </StyledBalance>
        </CardContent>
        <Footnote>
          ...
          <FootnoteValue>
            ...
            {/*${parseFloat(getBalanceNumber(totalSupply).toFixed(2)).toLocaleString('en-US')}*/}
            {totalSupply ? `--- CMT` : '~'}
          </FootnoteValue>
        </Footnote>
      </Card>
